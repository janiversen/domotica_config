...
class CalcSensor(Base, RestoreSensor, SensorEntity):
    ...
    def __init__(
        ...
        """Initialize entity."""
        super().__init__(hass, name, device_class, measurement_unit)
        self._attr_unique_id = f"sensor.{name}"
...
class CalcSwitch(Base, RestoreEntity, SwitchEntity):
    ...
    def __init__(
        ...
        """Initialize entity."""
        super().__init__(hass, name, device_class, None)
        self._attr_unique_id = f"switch.{name}"
